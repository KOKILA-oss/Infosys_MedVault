    ...
    return (
      <div className="reschedule-page">
        <div className="reschedule-card">
          ...
          <button className="primary-btn" onClick={() => navigate('/doctor-appointments')}>
    ...
    <div className="reschedule-page">
      <div className="reschedule-card">
        <header>
          ...
          <p>{appointment.patientName || 'Patient'} • {appointment.hospital}</p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="reschedule-form">
          ...
          <div className="reschedule-actions">
            <button type="button" className="ghost-btn" onClick={() => navigate('/doctor-appointments')}>
              Cancel
            </button>
